                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <div class="form-group row align-items-center">
                                    <label for="example-date" class="col-sm-3 col-form-label">Tanggal Pengaduan</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" id="inputEmail3" placeholder="Foto">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Inventarisasi</label>
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" id="inputEmail3"
                                            placeholder="Inventarisasi">
                                    </div>
                                </div>
